...
export default function AllUnavailableStock(props) {
    const { id } = useParams();
    ...
    const [selectedOption, setSelectedOption] = useState('Out of Stock');
            ...
            <div className='light px-2'>
                ...
                <div className="bg-white px-2 box-shadow rounded">
                    ...
                    {/* <div className="text-end">
                        <Link className="btn-blue btn btn-sm" to={'/add-stock/' + user.inventoryID}>
                            Add Stock <Add />
                        </Link>
                    </div> */}
                    <br />
                    ...
                    <div className="flex">
                        ...
                        <div className='ms-3'>
                            ...
                            >
                                ...
                                <option value="In Stock" disabled>In Stock</option>
