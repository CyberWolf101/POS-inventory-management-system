...
function CustomerActionsModal({ isOpen, onClose, theCustomer, inventoryData, handleGetInventoryData }) {
    ...
    const handleDelete = () => {
        const idToRemove = theCustomer.id;
        const theArray = inventoryData.customers;
        ...
        swal({
            ...
            if (willDelete) {
                setLaoding(true)
                const filteredArray = theArray.filter((customer) => customer.id !== idToRemove);
            ...
            <Modal isOpen={isOpen} onClose={onClose} >
                ...
                <ModalContent style={{ marginTop: '200px' }}>
                    <center className='modalHeader'>
                        <ModalHeader><h6>{theCustomer.name}</h6></ModalHeader>
                        <ModalCloseButton />
                    </center>
                    <ModalBody className='' >
                        <center>
